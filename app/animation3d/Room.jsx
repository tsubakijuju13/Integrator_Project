...
export function Model(props) {
  const { nodes, materials } = useGLTF("/assets/models/room-transformed.glb")
  return (
    <group {...props} dispose={null} onPointerEnter={(e)=>e.stopPropagation()}>
...
useGLTF.preload("/assets/models/room-transformed.glb")
